'========加载测试数据--调试用
'datatable.ImportSheet "..\..\Sumitomo\TestData\CheckUnlockSet.xls",1,"Global"
'datatable.ImportSheet "..\..\Sumitomo\TestData\CheckUnlockSet.xls",2,"Action1"
'动态加载对象库,关注相对路径的问题
	...
	For i=1 to wt.ColumnCount(1)
		...
		Select Case ColName
			...
			Case "提交帐户":				
				...
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CommAccount","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CommAccount","Action1")&" 实际值："&ColVal
				end if
			Case "立即锁":
				if(ColVal=Datatable("ExpUnlockSet_ImmeLock","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_ImmeLock","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_ImmeLock","Action1")&" 实际值："&ColVal
				end if
			Case "总工作时间锁":
				if(ColVal=Datatable("ExpUnlockSet_WorkTimeLock","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_WorkTimeLock","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_WorkTimeLock","Action1")&" 实际值："&ColVal
				end if
			Case "指定总工作时间":
				if(ColVal=Datatable("ExpUnlockSet_WorkTimeLock_Hour","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_WorkTimeLock_Hour","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_WorkTimeLock_Hour","Action1")&" 实际值："&ColVal
				end if
			Case "指定日期锁":
				if(ColVal=Datatable("ExpUnlockSet_AppDateLock","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppDateLock","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppDateLock","Action1")&" 实际值："&ColVal
				end if
			Case "指定时间":
				if(ColVal=Datatable("ExpUnlockSet_AppDateLock_Date","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppDateLock_Date","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppDateLock_Date","Action1")&" 实际值："&ColVal
				end if
			Case "位置锁":
				if(ColVal=Datatable("ExpUnlockSet_AppPosiLock","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock","Action1")&" 实际值："&ColVal
				end if
			Case "指定经度":
				if(ColVal=Datatable("ExpUnlockSet_AppPosiLock_Long","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock_Long","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock_Long","Action1")&" 实际值："&ColVal
				end if
			Case "指定纬度":
				if(ColVal=Datatable("ExpUnlockSet_AppPosiLock_Lati","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock_Lati","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock_Lati","Action1")&" 实际值："&ColVal
				end if
			Case "半径":
				if(ColVal=Datatable("ExpUnlockSet_AppPosiLock_Radi","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock_Radi","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_AppPosiLock_Radi","Action1")&" 实际值："&ColVal
				end if
			Case "循环密码锁":
				if(ColVal=Datatable("ExpUnlockSet_CircDateLock","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CircDateLock","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CircDateLock","Action1")&" 实际值："&ColVal
				end if
			Case "循环密码锁时间":
				...
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CircDateLock_Date","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CircDateLock_Date","Action1")&" 实际值："&ColVal
				end if
			Case "期数":
				'解车页面无此字段设置，故期望值设置为空
				if(ColVal=Datatable("ExpUnlockSet_CircDateLock_LockM","Action1"))then
				reporter.ReportEvent micPass,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CircDateLock_LockM","Action1")&" 实际值："&ColVal
				else
				reporter.ReportEvent micFail,"解车设置结果列表-"&ColName&"检查","期望值："&Datatable("ExpUnlockSet_CircDateLock_LockM","Action1")&" 实际值："&ColVal
				end if
		End Select
	Next
	'========下载功能
